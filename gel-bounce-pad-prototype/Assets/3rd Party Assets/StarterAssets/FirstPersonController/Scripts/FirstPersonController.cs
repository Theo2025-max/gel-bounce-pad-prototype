...
namespace StarterAssets
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        // summary
        // I made this so that we can launch the player upward.
        // It will be used by the Jelly Bounce Pad.
        // End of summary
        public void Launch(float launchHeight)
        {
            _verticalVelocity = Mathf.Sqrt(launchHeight * -2f * Gravity);
        }
